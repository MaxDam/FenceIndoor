...
public class ServiceAddArea extends IntentService {

	private String TAG = ServiceAddArea.class.getName();
	...
	public ServiceAddArea() {
        super("ServiceAddArea");
    }
